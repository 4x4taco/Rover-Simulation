...
def update_rover(Rover, data):
      ...
      if Rover.start_time == None:
            ...
            while(Rover.start_initpos_count < 1):#while loop that allows initial postion varibles to be saved
                Rover.start_xpos = samples_xpos
                Rover.start_ypos = samples_ypos
                Rover.start_initpos_count = Rover.start_initpos_count + 1
